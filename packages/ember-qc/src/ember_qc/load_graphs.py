...
# ==============================================================================
# MANIFEST AUTHORING TOOL (not called at runtime)
# ==============================================================================

def generate_manifest(graph_dir: Path = GRAPHS_DIR,
                      manifest_path: Path = MANIFEST_PATH) -> Path:
    """Regenerate manifest.json from the bundled graph library.

    Run this once after adding or modifying graphs; commit the result.
    ...
    try:
        version = importlib.metadata.version("ember-qc")
    except Exception:
        version = "dev"
    ...
    manifest_path.write_text(
        json.dumps({"version": version, "graphs": entries}, indent=2) + "\n",
        encoding="utf-8",
    )
